...
import { Utensils, Mail, Lock, Eye, EyeClosed, ChevronLeft } from 'lucide-vue-next'
        ...
        <div class="w-full flex flex-col gap-2">
          ...
          >
            ...
            <Input
              ...
              class="w-full h-full text-sm sm:text-sm md:text-md shadow-none border-none focus:border-none focus-visible:ring-0"
            />
          </div>
        </div>
        <div class="w-full flex flex-col gap-2">
